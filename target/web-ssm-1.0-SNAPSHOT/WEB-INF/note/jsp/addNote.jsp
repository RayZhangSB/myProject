...
<script language="javascript">
    ...
    function validationNoteForm() {
        ...
        if (document.getElementById("noteDesc").value === '') {
            alert("描述不能为空");
            return false;
        }
        return true;
    ...
    function add_Note_Submit() {
        ...
        formData.append("noteDesc", dom("noteDesc").value);
        $.ajax({
            type: "POST",
...
<div id="add_note" style="padding:10px 10px 10px 10px">
    ...
    <table>
        ...
        <tr>
            <td>大标题:<input autofocus="autofocus" type="text" name="title" id="title" placeholder="大标题最多15字" maxlength="15"></td>

        </tr>
        <tr>
            <td>小标题:<input autofocus="autofocus" type="text" name="subTitle" id="subTitle" placeholder="小标题最多15字"
                        maxlength="15"></td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td><textarea autofocus="autofocus" style="width:400px;height:200px;" name="noteDesc"
                          id="noteDesc" placeholder="内容描述：不超过150字"></textarea>
            </td>
        </tr>
        <tr>
            <td>
