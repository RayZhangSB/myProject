...
public class UserServiceImpl implements UserService {
    ...
    public String registerUser(User user) {
        ...
        if (u != null) {
            code = 1;
            msg = "用户已经注册过了";
            return JsonUtils.getJSONString(code, msg);
        }
        String salt = IDUtils.genSalt();
        user.setUserSalt(salt);
        user.setUserPassword(IDUtils.encodedString(user.getUserPassword() + salt));
    ...
    public Map<String, Object> userLogin(String userName, String userPassword) {
        ...
        if (res == null) {
            ...
            if (IDUtils.encodedString(userPassword + res.getUserSalt()).equals(res.getUserPassword())) {
        ...
        map.put("resultJson", JsonUtils.getJSONString(code, msg));
        return map;
